...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_11.setGeometry(QtCore.QRect(20, 784, 171, 21))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(10)
        self.label_11.setFont(font)
        self.label_11.setObjectName("label_11")
        self.BUCTLabel = QtWidgets.QLabel(self.centralwidget)
        self.BUCTLabel.setGeometry(QtCore.QRect(21, 810, 90, 90))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(10)
        self.BUCTLabel.setFont(font)
        self.BUCTLabel.setText("")
        self.BUCTLabel.setObjectName("BUCTLabel")
        self.NEULabel = QtWidgets.QLabel(self.centralwidget)
        self.NEULabel.setGeometry(QtCore.QRect(190, 810, 90, 90))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(10)
        self.NEULabel.setFont(font)
        self.NEULabel.setText("")
        self.NEULabel.setObjectName("NEULabel")
        self.SHULabel = QtWidgets.QLabel(self.centralwidget)
        self.SHULabel.setGeometry(QtCore.QRect(370, 810, 90, 90))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(10)
        self.SHULabel.setFont(font)
        self.SHULabel.setText("")
        self.SHULabel.setObjectName("SHULabel")
        self.TJULabel = QtWidgets.QLabel(self.centralwidget)
        self.TJULabel.setGeometry(QtCore.QRect(540, 810, 90, 90))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(10)
        self.TJULabel.setFont(font)
        self.TJULabel.setText("")
        self.TJULabel.setObjectName("TJULabel")
        self.ZJLabLabel = QtWidgets.QLabel(self.centralwidget)
        self.ZJLabLabel.setGeometry(QtCore.QRect(740, 810, 90, 90))
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(10)
        self.ZJLabLabel.setFont(font)
        self.ZJLabLabel.setText("")
        self.ZJLabLabel.setObjectName("ZJLabLabel")
        ...
        self.widget = QtWidgets.QWidget(self.objectModuleGroupBox)
        self.widget.setGeometry(QtCore.QRect(10, 30, 101, 63))
        self.widget.setObjectName("widget")
        self.verticalLayout = QtWidgets.QVBoxLayout(self.widget)
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout.setObjectName("verticalLayout")
        self.singleObjectRadioButton = QtWidgets.QRadioButton(self.widget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(10)
        ...
        self.multipleObjectRadioButton = QtWidgets.QRadioButton(self.widget)
        font = QtGui.QFont()
        font.setFamily("Microsoft YaHei")
        font.setPointSize(10)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_11.setText(_translate("MainWindow", "Cooperate partners:"))
